...
class Animation:
    def __init__(self, frame_width: int, n_frames: int, frame_time: float, filename: str) -> None:
        ...
        self.__FRAME_HEIGHT = self.__sprite.get_rect().size[1] // n_frames
    ...
    def update(self, dt: float, state = 0) -> None:
        ...
        if (self.__cur_time >= self.__FRAME_TIME):
            ...
            new_x = state * self.__FRAME_WIDTH
            new_y = self.__cur_frame * self.__FRAME_HEIGHT
